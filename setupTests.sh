...
curCFiles=\
`find "${src}" -path "${src}/tests/CuTest.c" -prune \
            -o -path "${src}/tests/unslicedTests.c" -prune \
            -o -path "${src}/tests/testSlice.c" -prune \
            -o -path "${src}/test.c" -prune \
            -o -type f -name *.c -print`
